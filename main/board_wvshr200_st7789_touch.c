...
// Native panel is 240×320 portrait; we run it in landscape (swap_xy below)
// to reuse the existing 320×240 CYD dashboard layout.
...
{
    return -1;  // Waveshare 2.0 Touch has no dedicated user button
}
